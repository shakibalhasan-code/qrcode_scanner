...
class AppColors {
  ...
  static const Color success = Color(0xFF4CAF50); // Green for checkmarks
  static const Color accentRed = Color(0xFFF24E4E); // Red for timer
  static const Color lightGrey = Color(0xFFBCC5D3); // Light grey for Resend text
}